...
bool Mob::isSeePlayer(Player &player, const std::vector<sf::FloatRect> &allWallBounds)
{
    ...
    bool point1InVis = sqrt(pow(playerPoint1.x - mobCenterPoint.x, 2) + pow(playerPoint1.y - mobCenterPoint.y, 2)) <= visDistance;
    bool point2InVis = sqrt(pow(playerPoint2.x - mobCenterPoint.x, 2) + pow(playerPoint2.y - mobCenterPoint.y, 2)) <= visDistance;
    bool point3InVis = sqrt(pow(playerPoint3.x - mobCenterPoint.x, 2) + pow(playerPoint3.y - mobCenterPoint.y, 2)) <= visDistance;
    bool point4InVis = sqrt(pow(playerPoint4.x - mobCenterPoint.x, 2) + pow(playerPoint4.y - mobCenterPoint.y, 2)) <= visDistance;
